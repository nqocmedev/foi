...
<body class="bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen"> 
    ...
    <div id="page-transition" class="page-transition">
        ...
        <div class="loading-logo">DevProfile Pro</div>
    </div>
    ...
    <a href="#profile" class="font-medium hover:text-primary transition-colors menu-link">Hồ Sơ</a>
    <a href="#payment" class="font-medium hover:text-primary transition-colors menu-link">Thanh Toán</a>
    <a href="#contact" class="font-medium hover:text-primary transition-colors menu-link">Liên Hệ</a>
    <a href="#about" class="font-medium hover:text-primary transition-colors menu-link">Giới Thiệu</a>
    <!-- Nút Cửa Hàng -->
    <a href="https://ceotvnqoc.shop" target="_blank" 
       class="font-medium hover:text-primary transition-colors bg-gradient-to-r from-red-500 to-orange-500 text-white px-4 py-2 rounded-lg hover:shadow-lg transition-all menu-link store-btn">
        <i class="fas fa-shopping-cart mr-2"></i> Cửa Hàng
    </a>
</nav>
    ...
    <div class="flex flex-col py-4 px-4 space-y-3">
        <a href="#profile" class="font-medium hover:text-primary transition-colors py-2 menu-link">Hồ Sơ</a>
        <a href="#payment" class="font-medium hover:text-primary transition-colors py-2 menu-link">Thanh Toán</a>
        <a href="#contact" class="font-medium hover:text-primary transition-colors py-2 menu-link">Liên Hệ</a>
        <a href="#about" class="font-medium hover:text-primary transition-colors py-2 menu-link">Giới Thiệu</a>
        <!-- Nút Cửa Hàng cho mobile -->
        <a href="https://ceotvnqoc.shop" target="_blank" 
           class="font-medium hover:text-primary transition-colors py-2 bg-gradient-to-r from-red-500 to-orange-500 text-white px-4 py-2 rounded-lg hover:shadow-lg transition-all menu-link store-btn">
            <i class="fas fa-shopping-cart mr-2"></i> Cửa Hàng
        </a>
    </div>
</div>
